...
public class TakeExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        SparkConf conf = new SparkConf().setMaster("local").setAppName("TakeExample");
        JavaSparkContext sc = new JavaSparkContext(conf);

        List<String> list = Arrays.asList("hadoop", "bigdata", "spark", "kafka", "hive");
        JavaRDD<String> rdd1 = sc.parallelize(list, 3);

        List<String> resultList = rdd1.take(3);
